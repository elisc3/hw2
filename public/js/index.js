function apertura(event){
    ...
    if (nav_menu.classList.contains("menu-open")) {
        // chiusura del menu a tendina INIZIO
        ...
        return;
        // chiusura del menu a tendina FINE
    }
    else{
        // apertura del menu a tendina INIZIO
        ...
        // apertura del menu a tendina FINE
    }
...
function cambio(event) {
    ...
    let lista=[{name: "Sala Antares", img : "img/mirador5.jpg"},
               {name: "Sala Sinfonia", img : "img/mirador7.jpg" },
               {name: "Sala Congressi", img : "img/mirador8.jpg"},
               {name: "Sala Luxury", img : "img/mirador9.jpg"}
              ];
    console.log( lista );
...
function toggleMeteo() {
    ...
    const meteo_url = 'https://api.openweathermap.org/data/2.5/weather?lat=37.7029028&lon=15.1130236&units=metric&appid=secret&lang=it';
...
function toggleMappa() {
    ...
    // sto aprendo il box della mappa
